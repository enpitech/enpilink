...
description: "Develop Apps locally with enpilink's DevTools and Vite HMR for instant feedback without tunneling."
---
...
**Solution:** enpilink includes DevTools and a Vite HMR plugin that let you develop views entirely on your machine with instant feedback.
...
<img src="/images/devtools-landing.png" alt="enpilink DevTools" style={{maxWidth: '100%', borderRadius: '8px', border: '1px solid #e0e0e0'}} />
...
Your view code works identically in ChatGPT, MCP Apps clients like Claude, and local DevTools. enpilink detects the environment and uses the appropriate communication layer:
