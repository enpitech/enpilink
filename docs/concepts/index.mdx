---
title: Core Concepts
description: "Understand the five key concepts that power enpilink: write once run everywhere, data flow, LLM context sync, fast iteration, and type safety."
---
...
<Tip>
**Start with Write Once, Run Everywhere** — it explains how enpilink abstracts runtime differences so you can focus on your app.
</Tip>
