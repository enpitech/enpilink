---
title: Data Flow
description: "Learn how data moves between the host, your MCP server, and views in enpilink applications."
---
...
**Solution:** enpilink provides clear abstractions for each communication pattern.
