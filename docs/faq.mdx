---
title: FAQ
description: "Common questions and troubleshooting for enpilink type safety, deployment, and App development."
---
...
Make sure you're importing from your generated helpers file, not directly from `enpilink/web`:

```typescript
// Wrong
import { useCallTool } from "enpilink/web";

// Right
import { useCallTool } from "../enpilink";
```
...
2. Your `enpilink.ts` imports this type correctly
