---
title: useToolInfo
description: "React hook for accessing tool input, output, metadata, and execution status in enpilink views."
---
...
The input arguments passed to the tool. May be `undefined` until the host delivers the tool arguments.
