...
<Steps>
  ...
  <Step title="Build and deploy">
    Run `npm run deploy` to ship to [enpitech Cloud](https://enpitech.dev), or host on any Node.js-compatible infrastructure.
  </Step>
</Steps>
...
<CardGroup cols={3}>
  ...
  <Card title="Deploy" icon="cloud-arrow-up" href="/quickstart/deploy">
    Ship to enpitech Cloud, Cloudflare Workers, or self-host
  </Card>
</CardGroup>
