...
enpilink opens a public tunnel automatically and prints a public `/mcp` URL you can paste into Claude, ChatGPT, or any MCP client. Add `--verbose` to stream tunnel logs.
