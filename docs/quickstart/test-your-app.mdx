...
enpilink downloads and runs [enpitech tunnel](https://docs.enpitech.dev/cli/tunnel) automatically, then prints a public URL (e.g., `https://cool-marmot-fondue-420.enpitech.dev/mcp`).
...
2. Enter the printed `/mcp` URL:
   ```
   https://cool-marmot-fondue-420.enpitech.dev/mcp
   ```
3. Click **Create**
