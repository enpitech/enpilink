...
<Note>
These logs show **Apps SDK** (`window.openai`) calls. In MCP Apps, views use the MCP ext-apps protocol instead. The Skybridge hooks abstract these differences, so your view code works in both runtimes.
</Note>
